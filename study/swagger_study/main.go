...
func main() {
	...
	{
		download.POST("", DownAccountImage)
	}
...
// DownloadAccountImage godoc
// @Summary Download account image
// @Description Download file
// @Tags accounts
// @Accept  multipart/form-data
// @Produce  json
// @Param file string file true "account name"
// @Success 200 {object} controller.Message
// @Failure 400 {object} httputil.HTTPError
// @Failure 404 {object} httputil.HTTPError
// @Failure 500 {object} httputil.HTTPError
// @Router /accounts/{id}/download [post]
func DownAccountImage(ctx *gin.Context) {
	filename:= ctx.PostForm("file")
	ctx.Writer.Header().Add("Content-Disposition", fmt.Sprintf("attachment; filename=%s", filename))//对下载的文件重命名
